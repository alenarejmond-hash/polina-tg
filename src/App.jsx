                  ...
                  <div className="space-y-6">
                    ...
                    <div className="w-full fade-in">
                      ...
                      >
                        ...
                        <div className="absolute bottom-5 left-5 right-5 text-white z-30 flex items-end justify-between gap-3 pointer-events-none">
                          <h1 className="text-[28px] sm:text-3xl font-serif font-bold flex items-center gap-1.5 tracking-tight min-w-0 pointer-events-auto">
